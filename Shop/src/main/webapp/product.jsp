		...
		<script>
			$(function(){
				...
				$('.btnOrder').click(function(){
					let proNo = $(this).val();	
					$('section').show().find('input[name=proNo]').val(proNo);
				});
				...
				$('input[type=submit]').click(function(){
					...
					let proCount   = $('input[name=proCount]').val();
					let proOrderer = $('input[name=proOrderer]').val();
					
					let jsonData = {
						"proNo": proNo,
						"proCount": proCount,
						"proOrderer": proOrderer
					};
	...
	<body>
		...
		<table border="1">
			...
			<tr>
				...
				<td><%= pb.getPrice() %></td>
				<td><%= pb.getCompany() %></td>
				<td><button class="btnOrder" value="<%= pb.getProNo() %>">주문</button></td>
			</tr>
			<% } %>
		</table>
		...
		<section style="display: none">
			...
			<table border="1">
				<tr>
					<td>상품번호</td>
					<td><input type="text" name="proNo" readonly="readonly"/></td>
				</tr>
				<tr>
					<td>수량</td>
				...
				<tr>
					<td>주문자</td>
					<td><input type="text" name="proOrderer"/></td>
				</tr>
				<tr>
