...
<main id="user">
    <section class="register">
        ...
        <form action="/Farmstory2/user/register.do" method="post">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnEmail"><img src="/Farmstory2/user/img/chk_auth.gif" alt="인증번호 받기"/></button>
                        <div class="auth">
                            <input type="text" name="auth" placeholder="인증번호 입력"/>
                            <button type="button" id="btnEmailConfirm"><img src="/Farmstory2/user/img/chk_confirm.gif" alt="확인"/></button>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" onclick="postcode()"><img src="/Farmstory2/user/img/chk_post.gif" alt="우편번호찾기"/></button>
            ...
            <div>
                <a href="/Farmstory2/login.do" class="btn btnCancel">취소</a>
